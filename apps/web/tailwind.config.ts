  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'display-lg': ['32px', { lineHeight: '1.15', letterSpacing: '-0.02em', fontWeight: '600' }],
        'display-md': ['26px', { lineHeight: '1.2', letterSpacing: '-0.018em', fontWeight: '600' }],
        'display-sm': ['22px', { lineHeight: '1.25', letterSpacing: '-0.014em', fontWeight: '600' }],
        'heading-lg': ['18px', { lineHeight: '1.3', letterSpacing: '-0.01em', fontWeight: '600' }],
        'heading-md': ['15px', { lineHeight: '1.35', fontWeight: '600' }],
        'heading-sm': ['13px', { lineHeight: '1.35', fontWeight: '600' }],
        'body-lg': ['15px', { lineHeight: '1.55', fontWeight: '400' }],
